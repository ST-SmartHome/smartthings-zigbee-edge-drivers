...
local component=mapping_context.component
child_outlets.on_parent_event(device,type(component)=="table" and component.id or component,event)
return
end
...
if type(device.get_component_id_for_endpoint)=="function" then
child_outlets.on_parent_event(device,device:get_component_id_for_endpoint(mapping_context.endpoint),event)
end
return
end
