...
reportable_change_preference=type(mapping.reportable_change_preference)=="string" and mapping.reportable_change_preference or nil,
minimum_interval_preference=type(mapping.minimum_interval_preference)=="string" and mapping.minimum_interval_preference or nil,
