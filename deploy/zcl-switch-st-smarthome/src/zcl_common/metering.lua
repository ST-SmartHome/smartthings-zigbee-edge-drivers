...
-- ST-SmartHome: some plugs report a bogus multiplier/divisor pair (the
-- Mercator SPP02GIP reports a 0x200010 ratio); those mappings opt out and
-- always use their fixed meta.scale instead, matching Zigbee2MQTT.
