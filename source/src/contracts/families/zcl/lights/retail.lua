...
-- Z2M v26.99.0 C-ZB-RD1P-DPM: endpoint 1 is the local dimmer and
-- metering server; endpoint 2 emits the nine RD1P rotary/button actions.
-- Level-config reports keep numeric wire sentinels so the exact raw values
-- survive in SmartThings state. Commands expose Z2M's numeric ranges and use
