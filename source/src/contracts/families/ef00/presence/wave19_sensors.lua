-- Frozen Zigbee2MQTT v26.99 Wave19 presence/motion candidates.
...
-- Z2M 26.108.1 mowe.ts: core presence/lux; advanced radar settings deferred.
local mowe_mw833p = {
...
-- Lincukoo R12LM-Z20T core; unlike MW833P, presence is active at zero.
